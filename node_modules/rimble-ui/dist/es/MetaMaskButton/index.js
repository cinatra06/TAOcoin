...
var MMStyledButton = /*#__PURE__*/styled(StyledButton).withConfig({
  displayName: "MetaMaskButton__MMStyledButton",
...
var StyledButtonSolid = /*#__PURE__*/styled(MMStyledButton).withConfig({
  displayName: "MetaMaskButton__StyledButtonSolid",
...
var StyledButtonOutline = /*#__PURE__*/styled(MMStyledButton).withConfig({
  displayName: "MetaMaskButton__StyledButtonOutline",
...
var ButtonBody = function ButtonBody(_ref) {
  var children = _ref.children,
      size = _ref.size;
  return React.createElement(React.Fragment, null, React.createElement(MMlogo, {
    className: 'r-ff-icon',
    size: size
  }), children);
};
...
MetaMaskButton.propTypes = _objectSpread({}, Button.propTypes);
