...
Heading.defaultProps = _objectSpread({}, defaultProps, {
  as: 'h2',
  fontSize: '',
  theme: theme
});
Heading.propTypes = _objectSpread({}, Box.propTypes, {
...
Heading.h1.defaultProps = _objectSpread({}, defaultProps, {
  as: 'h1',
  fontSize: 6
});
...
Heading.h2.defaultProps = _objectSpread({}, defaultProps, {
  as: 'h2',
  fontSize: 5
});
...
Heading.h3.defaultProps = _objectSpread({}, defaultProps, {
  as: 'h3',
  fontSize: 4
});
...
Heading.h4.defaultProps = _objectSpread({}, defaultProps, {
  as: 'h4',
  fontSize: 3
});
...
Heading.h5.defaultProps = _objectSpread({}, defaultProps, {
  as: 'h5',
  fontSize: 2
});
...
Heading.h6.defaultProps = _objectSpread({}, defaultProps, {
  as: 'h6',
  fontSize: 1
});
