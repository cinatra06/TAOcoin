...
describe('ToastMessage component sanity', function () {
  ...
  it('matches generic snapshot', function () {
    var toastMessage = shallow(React.createElement(ToastMessage, null)).dive();
    expect(toastMessage).toMatchSnapshot();
  });
  it('matches processing snapshot', function () {
    var toastMessage = shallow(React.createElement(ToastMessage.Processing, null)).dive();
    expect(toastMessage).toMatchSnapshot();
  });
  it('matches success snapshot', function () {
    var toastMessage = shallow(React.createElement(ToastMessage.Success, null)).dive();
    expect(toastMessage).toMatchSnapshot();
  });
  it('matches failure snapshot', function () {
    var toastMessage = shallow(React.createElement(ToastMessage.Failure, null)).dive();
    expect(toastMessage).toMatchSnapshot();
  });
  it('matches full component shallow snapshot', function () {
    var toastMessage = shallow(React.createElement(ToastMessage, {
      variant: 'default',
      message: 'message',
  ...
  it('matches full component mount snapshot', function () {
    var toastMessage = mount(React.createElement(ThemeProvider, {
      theme: theme
...
describe('ToastMessage component unit tests', function () {
  it('displays message', function () {
    var toastMessage = mount(React.createElement(ToastMessage, {
