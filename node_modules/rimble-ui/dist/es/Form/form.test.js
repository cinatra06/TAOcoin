...
describe('Form component sanity', function () {
  ...
  it('matches default snapshot', function () {
    var component = render(React.createElement(Form, null));
    expect(component).toMatchSnapshot();
  });
  it('renders children elements', function () {
    var component = render(React.createElement(Form, null, React.createElement(Form.Field, {
      label: "Email",
      width: 1
  ...
  it('matches themed snapshot', function () {
    var component = render(React.createElement(ThemeProvider, {
      theme: theme
    }, React.createElement(Form, null, React.createElement(Form.Field, {
      label: "Email",
      width: 1
    }, React.createElement(Form.Input, {
      type: "email",
...
describe('Form validation', function () {
  it('adds was-validated class', function () {
    var component = mount(React.createElement(Form, null, React.createElement(Form.Field, {
      label: "Email",
      width: 1
    }, React.createElement(Form.Input, {
      type: "email",
