...
var OutlineButton = React.forwardRef(function (_ref, ref) {
  var children = _ref.children,
      icon = _ref.icon,
      iconpos = _ref.iconpos,
      props = _objectWithoutProperties(_ref, ["children", "icon", "iconpos"]);

  return React.createElement(StyledOutlineButton, _extends({}, props, {
    ref: ref
  }), React.createElement(ButtonBody, {
    icon: icon,
    iconpos: iconpos,
    children: children
  }));
});
OutlineButton.defaultProps = _objectSpread({}, SolidButton.defaultProps, {
  border: 1,
  borderColor: 'grey',
  boxShadow: 0
});
