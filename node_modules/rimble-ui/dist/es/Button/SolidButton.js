...
var SolidButton = React.forwardRef(function (_ref, ref) {
  var children = _ref.children,
      icon = _ref.icon,
      iconpos = _ref.iconpos,
      props = _objectWithoutProperties(_ref, ["children", "icon", "iconpos"]);

  return React.createElement(StyledSolidButton, _extends({}, props, {
    ref: ref
...
SolidButton.defaultProps = _objectSpread({}, Button.defaultProps, {
  borderRadius: 1,
  boxShadow: 1
});
