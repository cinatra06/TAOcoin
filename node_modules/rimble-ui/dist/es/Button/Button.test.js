...
describe('Button component sanity', function () {
  ...
  it('matches default snapshot', function () {
    var component = render(React.createElement(Button, null));
...
describe('Button.Outline component sanity', function () {
  it('matches default snapshot', function () {
    var component = render(React.createElement(Button.Outline, null));
    expect(component).toMatchSnapshot();
  });
  it('matches themed snapshot', function () {
    var component = render(React.createElement(ThemeProvider, {
      theme: theme
    }, React.createElement(Button.Outline, null)));
    expect(component).toMatchSnapshot();
  });
});
describe('Button.Text component sanity', function () {
  it('matches default snapshot', function () {
    var component = render(React.createElement(Button.Text, null));
    expect(component).toMatchSnapshot();
  });
  it('matches themed snapshot', function () {
    var component = render(React.createElement(ThemeProvider, {
      theme: theme
    }, React.createElement(Button.Text, null)));
    expect(component).toMatchSnapshot();
  });
});
describe('Button size variant component sanity', function () {
  it('matches default snapshot', function () {
    var component = render(React.createElement(Button, {
      size: 'small'
    }));
    expect(component).toMatchSnapshot();
  });
...
describe('Loading Button component sanity', function () {
  it('matches default snapshot', function () {
    var component = render(React.createElement(Button, null, React.createElement(Loader, {
      color: 'white'
    })));
    expect(component).toMatchSnapshot();
  });
...
describe('Link Button Outline component sanity', function () {
  it('matches default snapshot', function () {
    var component = render(React.createElement(Button.Outline, {
      as: 'a',
      href: '#!',
      target: '_blank',
      title: 'Learn more'
